...
//		revolve_add=500;		
		...
		else if(switch_is_down(chassis_move_rc_to_vector->chassis_RC->rc.s[CHASSIS_MODE_CHANNEL])||switch_is_up(chassis_move_rc_to_vector->chassis_RC->rc.s[CHASSIS_MODE_CHANNEL]))
		{
		revolve_add=0.0f;
		revolve_flag=0;
		}
